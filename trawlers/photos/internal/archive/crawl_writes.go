...
func resetAssetDerivedRows(ctx context.Context, tx *sql.Tx, assetID string) error {
	...
	tables := []string{
		...
		"asset_fts", "current_photo_card", "photo_card_generation_transmission_attempt", "photo_card_generation_operation", "photo_card_generation", "failed_location_operation_history", "provider_location_transmission_attempt",
