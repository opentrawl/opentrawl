...
func resetAssetDerivedRows(ctx context.Context, tx *sql.Tx, assetID string) error {
	...
	tables := []string{
		...
		"asset_fts", "current_photo_card", "photo_model_generation_transmission_attempt", "photo_model_generation_operation", "photo_card_generation", "photo_text_extraction", "failed_location_operation_history", "provider_location_transmission_attempt",
