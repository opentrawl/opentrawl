...
type CurrentStillFetchRequest struct {
	...
	ModificationUnixSeconds  int64                  `protobuf:"varint,3,opt,name=modification_unix_seconds,json=modificationUnixSeconds,proto3" json:"modification_unix_seconds,omitempty"`
...
func (x *CurrentStillFetchRequest) GetModificationUnixSeconds() int64 {
	if x != nil {
		return x.ModificationUnixSeconds
	}
	return 0
}
...
func (x *CurrentStillFetchRequest) GetModificationMicroseconds() int32 {
	if x != nil {
...
const file_opentrawl_photos_fetch_v1_current_still_fetch_proto_rawDesc = "" +
	...
	"\x19modification_unix_seconds\x18\x03 \x01(\x03R\x17modificationUnixSeconds\x12)\n" +
