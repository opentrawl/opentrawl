...
enum TrawlDesign {
  ...
  static let onboardingPageWidth: CGFloat = 920
  ...
  static let onboardingReadingWidth: CGFloat = onboardingPageWidth
  static let onboardingCopyWidth: CGFloat = onboardingPageWidth
