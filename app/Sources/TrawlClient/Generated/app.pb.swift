...
public nonisolated struct Trawl_App_V1_SyncEvent: Sendable {
  ...
  public var result: Trawl_Federation_V1_FederatedTrawlerArchiveSyncOperation {
    get {
      if case .result(let v)? = kind {return v}
      return Trawl_Federation_V1_FederatedTrawlerArchiveSyncOperation()
    }
  ...
  public nonisolated enum OneOf_Kind: Equatable, Sendable {
    ...
    case result(Trawl_Federation_V1_FederatedTrawlerArchiveSyncOperation)
...
nonisolated extension Trawl_App_V1_SyncEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Trawl_Federation_V1_FederatedTrawlerArchiveSyncOperation?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
