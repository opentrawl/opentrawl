...
public struct SearchSourceResult: Sendable, Equatable { public let sourceID: String; public let surface: String; public let whoResolved: WhoResolved?; public let hits: [SearchHit]; public let totalMatches: UInt64; public let truncated: Bool }
