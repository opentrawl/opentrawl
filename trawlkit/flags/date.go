...
// ErrDateFormat is returned when a value matches none of the fleet's four
// accepted date layouts. Callers wrap it in their own usage-error type, the
// same pattern as ErrLimitBelowOne.
var ErrDateFormat = errors.New("needs a time like 2026-07-04 12:00:00, 2026-07-04, or 2026-07-04T12:00:00Z.")
...
// an RFC3339Nano or RFC3339 timestamp, a local YYYY-MM-DD HH:MM:SS timestamp,
// or a bare YYYY-MM-DD date. Values without a timezone are read in the
// machine's local timezone — a person typing "2026-07-04" means their own
// day, not UTC's — and the returned time is always UTC.
...
// or displayed local second named by value. RFC3339 timestamps remain exact.
